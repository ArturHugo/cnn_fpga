...
vlog -sv -work work +incdir+/home/artur/Documents/UNB/TG/cnn_fpga/hardware/simulation/modelsim {/home/artur/Documents/UNB/TG/cnn_fpga/hardware/simulation/modelsim/test_fully_connected_tb.v}

vsim -t 1ps -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver -L rtl_work -L work -voptargs="+acc"  test_fully_connected_tb
add wave *

add wave -position insertpoint  \
sim:/test_fully_connected_tb/KERNEL_BUFFER_0/hold_kernel_i \
sim:/test_fully_connected_tb/KERNEL_BUFFER_0/kernel_valid_o \
sim:/test_fully_connected_tb/KERNEL_BUFFER_0/curr_kernel \
sim:/test_fully_connected_tb/KERNEL_BUFFER_0/kernel_o

add wave -position insertpoint  \
sim:/test_fully_connected_tb/FULLY_CONNECTED_0/weights_valid \
sim:/test_fully_connected_tb/FULLY_CONNECTED_0/weight_counter \
sim:/test_fully_connected_tb/FULLY_CONNECTED_0/curr_state

add wave -position insertpoint  \
sim:/test_fully_connected_tb/result_valid_0
add wave -position insertpoint  \
sim:/test_fully_connected_tb/result_valid_1

add wave -position insertpoint  \
sim:/test_fully_connected_tb/hold_data_0
add wave -position insertpoint  \
sim:/test_fully_connected_tb/data_valid_0
add wave -position insertpoint  \
sim:/test_fully_connected_tb/data_reg
add wave -position insertpoint  \
sim:/test_fully_connected_tb/SPATIAL_CONV_CORE_0/hold_data_internal
add wave -position insertpoint  \
sim:/test_fully_connected_tb/SPATIAL_CONV_CORE_0/buffered_elements
add wave -position insertpoint  \
sim:/test_fully_connected_tb/SPATIAL_CONV_CORE_0/conv_rows_left
add wave -position insertpoint  \
sim:/test_fully_connected_tb/SPATIAL_CONV_CORE_1/conv_rows_left

add wave -position insertpoint  \
sim:/test_fully_connected_tb/SPATIAL_CONV_CORE_0/bias_i
add wave -position insertpoint  \
sim:/test_fully_connected_tb/SPATIAL_CONV_CORE_0/kernel_i
add wave -position insertpoint  \
sim:/test_fully_connected_tb/SPATIAL_CONV_CORE_0/conv_result
add wave -position insertpoint  \
sim:/test_fully_connected_tb/SPATIAL_CONV_CORE_0/input_window
add wave -position insertpoint  \
sim:/test_fully_connected_tb/SPATIAL_CONV_CORE_0/pool_window
add wave -position insertpoint  \
sim:/test_fully_connected_tb/SPATIAL_CONV_CORE_0/channel_accumulator
add wave -position insertpoint  \
sim:/test_fully_connected_tb/SPATIAL_CONV_CORE_0/reset_accumulator

add wave -position insertpoint  \
sim:/test_fully_connected_tb/SPATIAL_CONV_CORE_1/bias_i
add wave -position insertpoint  \
sim:/test_fully_connected_tb/SPATIAL_CONV_CORE_1/kernel_i
add wave -position insertpoint  \
sim:/test_fully_connected_tb/SPATIAL_CONV_CORE_1/conv_result
add wave -position insertpoint  \
sim:/test_fully_connected_tb/SPATIAL_CONV_CORE_1/input_window
add wave -position insertpoint  \
sim:/test_fully_connected_tb/SPATIAL_CONV_CORE_1/pool_window
add wave -position insertpoint  \
sim:/test_fully_connected_tb/SPATIAL_CONV_CORE_1/channel_accumulator
add wave -position insertpoint  \
sim:/test_fully_connected_tb/SPATIAL_CONV_CORE_1/reset_accumulator
