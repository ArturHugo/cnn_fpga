...
module test_spatial_conv_core_layers_tb();
    ...
    localparam N_ROWS       = 10; // Imagem original: 214. Imagem redimensionada: 100
    localparam N_COLS       = 10; // Imagem original: 320. Imagem redimensionada: 100
    ...
    localparam OUTPUT_N_ROWS_0 = N_ROWS-KERNEL_SIZE+1;
    localparam OUTPUT_N_COLS_0 = N_COLS-KERNEL_SIZE+1;
    localparam OUTPUT_N_ROWS_1 = (OUTPUT_N_ROWS_0/POOL_SIZE) - KERNEL_SIZE+1;
    localparam OUTPUT_N_COLS_1 = (OUTPUT_N_COLS_0/POOL_SIZE) - KERNEL_SIZE+1;
    localparam OUTPUT_SIZE     = (OUTPUT_N_ROWS_1)*(OUTPUT_N_COLS_1)/(POOL_SIZE*POOL_SIZE);
    ...
    reg [ADDR_WIDTH-1:0] ramo_wraddress [0:N_KERNELS_1-1] = '{
        0
        , OUTPUT_SIZE
        , 2*OUTPUT_SIZE
    };
    ...
    kernel_buffer #(
        ...
        .ram_rdaddress_o (rkw0_rdaddress),
    ...
    kernel_buffer #(
        ...
        .ram_rdaddress_o (rkw1_rdaddress),
