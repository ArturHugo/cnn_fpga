...
vlog -sv -work work +incdir+/home/artur/Documents/UNB/TG/cnn_fpga/hardware/simulation/modelsim {/home/artur/Documents/UNB/TG/cnn_fpga/hardware/simulation/modelsim/test_spatial_simple_mnist_tb.v}

vsim -t 1ps -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver -L rtl_work -L work -voptargs="+acc"  test_spatial_simple_mnist_tb
add wave *

add wave -position insertpoint  \
sim:/test_spatial_simple_mnist_tb/result_valid_0
add wave -position insertpoint  \
sim:/test_spatial_simple_mnist_tb/hold_data_0
add wave -position insertpoint  \
sim:/test_spatial_simple_mnist_tb/hold_kernel_0
add wave -position insertpoint  \
sim:/test_spatial_simple_mnist_tb/result_valid_1
add wave -position insertpoint  \
sim:/test_spatial_simple_mnist_tb/hold_data_1
add wave -position insertpoint  \
sim:/test_spatial_simple_mnist_tb/hold_kernel_1

add wave -position insertpoint  \
sim:/test_spatial_simple_mnist_tb/rami_data_out
add wave -position insertpoint  \
sim:/test_spatial_simple_mnist_tb/rkw0_rdaddress
add wave -position insertpoint  \
sim:/test_spatial_simple_mnist_tb/rkw1_rdaddress
add wave -position insertpoint  \
sim:/test_spatial_simple_mnist_tb/rfc0_rdaddress
add wave -position insertpoint  \
sim:/test_spatial_simple_mnist_tb/clock_driver
add wave -position insertpoint  \
sim:/test_spatial_simple_mnist_tb/system_clock

add wave -position insertpoint  \
sim:/test_spatial_simple_mnist_tb/output_values_to_process
add wave -position insertpoint  \
sim:/test_spatial_simple_mnist_tb/total_cycles

add wave -position insertpoint  \
sim:/test_spatial_simple_mnist_tb/SPATIAL_CONV_CORE_0/input_window
add wave -position insertpoint  \
sim:/test_spatial_simple_mnist_tb/SPATIAL_CONV_CORE_0/pool_window
add wave -position insertpoint  \
sim:/test_spatial_simple_mnist_tb/SPATIAL_CONV_CORE_0/channel_accumulator
add wave -position insertpoint  \
sim:/test_spatial_simple_mnist_tb/SPATIAL_CONV_CORE_0/buffered_elements

add wave -position insertpoint  \
sim:/test_spatial_simple_mnist_tb/SPATIAL_CONV_CORE_1/input_window
add wave -position insertpoint  \
sim:/test_spatial_simple_mnist_tb/SPATIAL_CONV_CORE_1/pool_window
add wave -position insertpoint  \
sim:/test_spatial_simple_mnist_tb/SPATIAL_CONV_CORE_1/channel_accumulator
add wave -position insertpoint  \
sim:/test_spatial_simple_mnist_tb/SPATIAL_CONV_CORE_1/buffered_elements

add wave -position insertpoint  \
sim:/test_spatial_simple_mnist_tb/logits
add wave -position insertpoint  \
sim:/test_spatial_simple_mnist_tb/hold_data_fc
