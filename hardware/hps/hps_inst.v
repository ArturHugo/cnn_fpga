	hps u0 (
		...
		.hps_data_export                 (<connected-to-hps_data_export>),                 //              hps_data.export
		.hps_data_valid_export           (<connected-to-hps_data_valid_export>),           //        hps_data_valid.export
		...
		.hps_logits_retrieved_export     (<connected-to-hps_logits_retrieved_export>),     //  hps_logits_retrieved.export
		.hps_start_conv_export           (<connected-to-hps_start_conv_export>),           //        hps_start_conv.export
		.hps_state_export                (<connected-to-hps_state_export>),                //             hps_state.export
		.logit_0_export                  (<connected-to-logit_0_export>),                  //               logit_0.export
		.logit_1_export                  (<connected-to-logit_1_export>),                  //               logit_1.export
		.logit_2_export                  (<connected-to-logit_2_export>),                  //               logit_2.export
		.logit_3_export                  (<connected-to-logit_3_export>),                  //               logit_3.export
		.logit_4_export                  (<connected-to-logit_4_export>),                  //               logit_4.export
		.logit_5_export                  (<connected-to-logit_5_export>),                  //               logit_5.export
		.logit_6_export                  (<connected-to-logit_6_export>),                  //               logit_6.export
		.logit_7_export                  (<connected-to-logit_7_export>),                  //               logit_7.export
		.logit_8_export                  (<connected-to-logit_8_export>),                  //               logit_8.export
		.logit_9_export                  (<connected-to-logit_9_export>),                  //               logit_9.export
		...
		.debug_fc_hold_counter_export    (<connected-to-debug_fc_hold_counter_export>)     // debug_fc_hold_counter.export
	);
